...
min = pygame.image.load('/Users/tankisov_dilyarmail.ru/Downloads/mickeyclock.jpeg')
minrec = min.get_rect()
minrec.center=(392,388)


sec = pygame.image.load('/Users/tankisov_dilyarmail.ru/Downloads/mickeyclock.jpeg')
secrec = sec.get_rect()
